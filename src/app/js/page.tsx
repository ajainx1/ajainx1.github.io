...
export default function JumpstreetRedirect() {
  useEffect(() => {
    ...
    window.location.replace('https://jumpstreet.systems');
  }, []);

  return (
    <>
      {/* Raw script tag for instant redirect before React hydrates */}
      <script dangerouslySetInnerHTML={{ __html: `window.location.replace('https://jumpstreet.systems');` }} />
      <meta httpEquiv="refresh" content="0; url=https://jumpstreet.systems" />
      ...
      <div className="min-h-screen bg-[#0f0414] flex items-center justify-center font-sans text-white">
        <div className="text-center flex flex-col items-center">
          ...
          <h1 className="text-2xl font-bold tracking-tight mb-2">Redirecting to JumpStreet Systems...</h1>
          <p className="text-slate-400">Please wait while we securely transfer you to the trading platform.</p>
          <a 
            href="https://jumpstreet.systems" 
